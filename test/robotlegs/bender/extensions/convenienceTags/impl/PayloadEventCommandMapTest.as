...
package robotlegs.bender.extensions.convenienceTags.impl
{
	...
	import robotlegs.bender.extensions.convenienceTags.support.ExecuteWithParametersCommand;
	import robotlegs.bender.extensions.convenienceTags.support.IPayload;
	import robotlegs.bender.extensions.convenienceTags.support.NullPayload;
	import robotlegs.bender.extensions.convenienceTags.support.PayloadTaggedEvent;
	...
	public class PayloadEventCommandMapTest
	{
		...
		[Test]
		public function payload_is_passed_to_command():void
		{
			var payloadInstance:IPayload = new NullPayload();
			var payloadString:String = 'payload';
			var payloadObject:Object = {};
			subject.map(PayloadTaggedEvent.TYPE, PayloadTaggedEvent)
				.toCommand(ExecuteWithParametersCommand);
			dispatcher.dispatchEvent(new PayloadTaggedEvent(PayloadTaggedEvent.TYPE,
				payloadInstance, payloadString, payloadObject));

			assertThat(reported, array(payloadString, payloadInstance, payloadObject));
		}
